...
def test_convert_to_lowercase_with_numbers_and_symbols():
    ...
    assert convert_to_lowercase("Hello123 World! @#$%") == "hello123 world! @#$%"

def test_convert_to_lowercase_unicode():
    """Test conversion of a string with unicode characters."""
    assert convert_to_lowercase("ÁÉÍÓÚ") == "áéíóú"
